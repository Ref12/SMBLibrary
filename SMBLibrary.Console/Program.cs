...
public static class Program
{
    ...
    public static void Run()
    {
        ...
        {
            //new FileSystemShare("Code", new NTFileSystemAdapter(new GitFileSystem(@"C:\Code\DiscUtils")))
            //new FileSystemShare("Code", new NTFileSystemAdapter(new 
            new FileSystemShare("Code", new NTDirectoryFileSystem(@"C:\bin"))
#if WINDOWS
#else
        ...
        bool result = client.Connect(address.Address, transport, port: 445);
